...
function renderApp() {
  ...
  // Verhältnis auf Materialebene erhalten: x/y = tender/timber
  // Gesucht: x (tender), y (timber), so dass:
  // x / tenderRate * pulverPerExchange + y / timberRate * pulverPerExchange = pulverTotal
  // UND x/y = ratioTender / ratioTimber
  ...
  // Ziel: Finde einen gemeinsamen Faktor f, sodass:
  // x = f * ratioTender
  // y = f * ratioTimber
  // und resultierendes Pulver = pulverTotal
